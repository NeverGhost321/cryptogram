...
async def send_welcome_message(bot: Bot, user_id: int, username: str):
    ...
    second_text = (
        ...
        "<i>Советую ознакомиться перед\nтем, как ты начнешь торговлю:</i>\n\n"
        "• Моя личная история 🤫\n"
        "• Как я сделал +427% за год,\nуделяя всего 15 минут в день.\n"
        "• Фактическое доказательство\nмоих иксов (реальная статистика).\n"
        "• Как подписчик заработал на\nBMW X5 COMPETITION (160.000$).\n"
        "• +7.000$ как с куста, или 'как\nполучить в управление 500.000$'.\n"
        "• Политика, мироустройство,\nинсайды — как всё это связано с\nкриптой и финансовыми рынками?\n"
        "<i>(ссылки на посты в доработке)</i>\n\n"
        "Чтобы запустить бота — жми на\nкнопку /start ниже, welcome 👇🏽"
    )
